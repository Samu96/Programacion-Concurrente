...
public class Main extends Thread{
    public static void main(String[] args) {
        ...
        */
        ...
        FileReader filer1 = new FileReader(fileNames,fileContents);
        FileReader filer2 = new FileReader(fileNames,fileContents);
        
        FileProcessor filep1 = new FileProcessor(fileContents,wordFrequencies);
        FileProcessor filep2 = new FileProcessor(fileContents,wordFrequencies);
        FileProcessor filep3 = new FileProcessor(fileContents,wordFrequencies);
